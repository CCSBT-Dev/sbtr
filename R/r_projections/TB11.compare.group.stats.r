...
plot.one.stat <- function(plot.data, plot.title, abline.at=0, ngroups, nelements, group.labs) {
 ...
 compare.group.stats <- function(file.prefixes, yr.now=2011, yr.longterm=2025, zero.prefix="CONST\\v0\\CONST0_", 
                                 group.labs, element.labs, MP.yrs=c(2012,2034), quants=c(0.1,0.5,0.9)) {
