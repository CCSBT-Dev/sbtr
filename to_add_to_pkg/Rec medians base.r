...
med.rec.base <- function(s4files,B.ylim,xlim=c(1931,2031),leg.names=NULL,legend.x,legend.y)  {
  ...
  mtext(side=2,"Recruitment (millions)",cex=1.3,line=2.5)
  mtext(side=3,"Base case",cex=1.3,line=0.5)
  legend(x=legend.x,y=legend.y,legend=leg.names,pch=pch,col=plot.colors,lwd=2,cex=1,bty="n")
}
